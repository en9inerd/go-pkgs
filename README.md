...
- [type Set](<#Set>)
  - [func New\(name string\) \*Set](<#New>)
  - [func \(s \*Set\) Bool\(long, short string, def bool, usage string\) \*bool](<#Set.Bool>)
  - [func \(s \*Set\) Duration\(long, short string, def time.Duration, usage string\) \*time.Duration](<#Set.Duration>)
  - [func \(s \*Set\) FlagSet\(\) \*flag.FlagSet](<#Set.FlagSet>)
  - [func \(s \*Set\) Int\(long, short string, def int, usage string\) \*int](<#Set.Int>)
  - [func \(s \*Set\) Parse\(args \[\]string\) error](<#Set.Parse>)
  - [func \(s \*Set\) String\(long, short, def, usage string\) \*string](<#Set.String>)
  - [func \(s \*Set\) Var\(value flag.Value, long, short, usage string\)](<#Set.Var>)
